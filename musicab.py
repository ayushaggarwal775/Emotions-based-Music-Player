...
emotion = ["happy","nutral","sad","angry","fear"]
camera_port = 0 
ramp_frames = 30
...
gender_model_path = '/media/ankita/New Volume/Program/face_classification/trained_models/gender_models/simple_CNN.81-0.96.hdf5'
...
cv2.imwrite('ankita.png', bgr_image)
print (emotion_text)
l=emotion_text
